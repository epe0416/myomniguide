...
imagenCatalogo: "../../../assets/productos/catalogo/homo.png"
puntos: 55
nio:
  puntos: 55
  precio: 1340
...
empresario:
  argumentosVenta:
    - "Enfoque en nutrición prostática preventiva: Escudo antioxidante diario (Licopeno + Zinc) antes de que aparezcan desgastes por la edad."
    - "Protección dual: Integra la acción antioxidante en tejido prostático con el cuidado del tracto urinario (Arándano rojo)."
    - "Cero impacto glucémico: Fórmula 100% libre de azúcares o jarabes de maíz, apta para el control metabólico."

  loQueHace:
    - "Acumula licopeno y zinc en el tejido prostático para neutralizar especies reactivas de oxígeno (ROS)."
    - "Inhibe la adhesión de bacterias a las paredes del tracto urinario mediante proantocianidinas (PACs) de arándano."
    - "Aporta cofactores esenciales para el mantenimiento de niveles saludables de testosterona sérica y movilidad espermática."

  loQueNoHace:
    - "No es un estimulante sintético ni vasodilatador de acción inmediata: Su beneficio es la nutrición funcional a mediano y largo plazo."
    - "No es un medicamento para tratar la prostatitis o patologías severas: Es un complemento nutricional que acompaña el seguimiento urológico."
    - "No sustituye la revisión médica urológica anual."

  tipsDemostra:
    - "Servir bien frío para resaltar su fresco sabor a mandarina."
    - "Sugerir combinaciones estratégicas: con Power Maker para rendimiento físico y vascular, o con Magnus para jornadas laborales exigentes."
---
